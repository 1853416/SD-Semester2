...
public class Adapter_Appointment_History_Patient extends FirestoreRecyclerAdapter<Note_Booking, Adapter_Appointment_History_Patient.Holder_Note_Appointment>{
    ...
    @Override
    protected void onBindViewHolder(@NonNull Adapter_Appointment_History_Patient.Holder_Note_Appointment holder, int position, @NonNull Note_Booking model) {
    ...
    @NonNull
    @Override
    public Adapter_Appointment_History_Patient.Holder_Note_Appointment onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater
                .from(parent.getContext())
                .inflate(R.layout.card_appointment_past_patient,parent,false);
        return new Adapter_Appointment_History_Patient.Holder_Note_Appointment(view);
    }

...
btnSave.addEventListener('click', e => {
  ...
  function sendEmail() {
	...
	Body : "Good Day " +pname.value+ "," + "<br>" + "Your appointment with "+ dname.value + " is at " + time.value +" on " + dateOfVisit.value +"." + "<br>" + "Please come 10 minutes before your appointment starts." + "<br>"+ "Please bring all of your medication." + "<br>" + "Thank You for using NotDiscovery!", 
	}).then(
